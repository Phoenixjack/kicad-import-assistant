...
def create_symbol_preview_file(
    ...
    if not source_symbol_path:
        dbg_print("No source symbol selected; skipping symbol preview.", Severity.VERBOSE, "symbols", "preview", "symbol_editor")
        return result
    ...
    dbg_print("Created symbol preview file:", Severity.VERBOSE, "symbols", "preview", "symbol_editor")
    dbg_print(f"Source: {source_symbol_path}", Severity.VERBOSE, "symbols", "preview", "symbol_editor")
    dbg_print(f"Preview: {preview_symbol_path}", Severity.VERBOSE, "symbols", "preview", "symbol_editor")
    dbg_print(f"Old symbol name: {old_symbol_name}", Severity.VERBOSE, "symbols", "preview", "symbol_editor")
    dbg_print(f"New symbol name: {basename}", Severity.VERBOSE, "symbols", "preview", "symbol_editor")
    dbg_print(f"Footprint property: {footprint_property}", Severity.VERBOSE, "symbols", "preview", "symbol_editor")
...
def create_symbol_library_backup(
    ...
    dbg_blank(Severity.VERBOSE, "symbols", "backup", "symbol_editor")
    dbg_print("Created symbol library backup:", Severity.VERBOSE, "symbols", "backup", "symbol_editor")
    dbg_print(f"Source: {target_symbol_file}", Severity.VERBOSE, "symbols", "backup", "symbol_editor")
    dbg_print(f"Backup: {backup_path}", Severity.VERBOSE, "symbols", "backup", "symbol_editor")
...
def merge_symbol_preview_into_target(
    ...
    dbg_blank(Severity.VERBOSE, "symbols", "merge", "symbol_editor")
    dbg_print("Merged preview symbol into target library:", Severity.VERBOSE, "symbols", "merge", "symbol_editor")
    dbg_print(f"Preview: {preview_symbol_file}", Severity.VERBOSE, "symbols", "merge", "symbol_editor")
    dbg_print(f"Target: {target_symbol_file}", Severity.VERBOSE, "symbols", "merge", "symbol_editor")
    dbg_print(f"Symbol: {new_symbol_name}", Severity.VERBOSE, "symbols", "merge", "symbol_editor")
